...
using Core.Asoects.Autofac.Validation;
...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public IResult Add(Product product)
        {
            ...
            IResult result = BusinessRules.Run(CheckIfCountOfCategorryCorrect(product.CategoryId),
        ...
        private IResult CheckIfCountOfCategorryCorrect(int categoryId)
        {
